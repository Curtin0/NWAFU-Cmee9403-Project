...
class Ui_MainWindow(object):  # 新建一个类Ui_MainWindow继承object的属性
    def setupUi(self, MainWindow):
        ...
        self.groupBox_imageRegion.setGeometry(QtCore.QRect(15, 40, 1050, 365))
        self.groupBox_imageRegion.setFont(font_bold)
        
        self.label_imageRegion = QtWidgets.QLabel(MainWindow)
        self.label_imageRegion.setGeometry(QtCore.QRect(15, 30, 120, 40))
        
        self.label_cameraImage_front  = QtWidgets.QLabel(MainWindow)
        self.label_cameraImage_front.setGeometry(QtCore.QRect(35, 70, 200, 150))
        ...
        self.label_originalImage_front.setGeometry(QtCore.QRect(237, 70, 200, 150))
        ...
        self.label_diseaseImage_front.setGeometry(QtCore.QRect(439, 70, 200, 150))
        ...
        self.label_crackleImage_front.setGeometry(QtCore.QRect(641, 70, 200, 150))
        ...
        self.label_gradeImage_front.setGeometry(QtCore.QRect(843, 70, 200, 150))
        ...
        self.label_cameraImage_back.setGeometry(QtCore.QRect(35, 232, 200, 150))
        ...
        self.label_originalImage_back.setGeometry(QtCore.QRect(237, 232, 200, 150))
        ...
        self.label_diseaseImage_back.setGeometry(QtCore.QRect(439, 232, 200, 150))
        ...
        self.label_crackleImage_back.setGeometry(QtCore.QRect(641, 232, 200, 150))
        ...
        self.label_gradeImage_back.setGeometry(QtCore.QRect(843, 232, 200, 150))
        ...
        self.groupBox_disease.setGeometry(QtCore.QRect(80, 550, 235, 130))
        ...
        self.groupBox_crackle.setGeometry(QtCore.QRect(330, 550, 235, 130))
        ...
        self.groupBox_grade.setGeometry(QtCore.QRect(580, 550, 470, 130))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "基于Python语言与机器视觉的红枣分机软件V1.0"))
    ...
    def paintEvent(self, event):
        ...
        qp_label_image.drawRect(35, 232, 1008, 150)
        qp_label_image.drawRect(35, 70, 1008, 150)
        qp_label_image.drawLine(237, 70, 237, 220)
        qp_label_image.drawLine(439, 70, 439, 220)
        qp_label_image.drawLine(641, 70, 641, 220)
        qp_label_image.drawLine(843, 70, 843, 220)
        qp_label_image.drawLine(237, 232, 237, 382)
        qp_label_image.drawLine(439, 232, 439, 382)
        qp_label_image.drawLine(641, 232, 641, 382)
        qp_label_image.drawLine(843, 232, 843, 382)
        qp_label_image.end()